                ...
                <div class="content-wrapper">
                    ...
                    <div class="div_center">
                        ...
                        <form action="{{url('add_user')}}" method="POST" enctype="multipart/form-data">
                            ...
                            <label>Email</label>
                            <input type="email" name="email" id="" class="input_color" placeholder="Masukkan Email"
                                required><br><br>

                            <label>Nomor Telpon</label>
                            <input type="number" name="phone" id="" class="input_color"
                                placeholder="Masukkan Nomor Telpon" required><br><br>
